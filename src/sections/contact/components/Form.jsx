    ...
    if (isSent) {
        return (
            <div className="min-h-[568px] lg:min-h-[456px] flex flex-col items-center justify-center gap-3 rounded-2xl bg-gray lg:px-18 px-8 py-5 text-center font-manrope">
                ...
                <button 
                    className="group mt-3 flex flex-row items-center justify-center rounded-[22px] border-2 px-3.5 py-1 font-semibold text-blue hover:cursor-pointer border-blue hover:bg-blue hover:text-white active:bg-blue active:text-white transition-colors duration-200"
                    onClick={handleReset}
                >
                    Retour
                </button>
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-7">
            ...
            <FormInput
                ...
                onInputChange={handleInputChange}
            />
            <button type="submit" className="flex min-h-[48px] flex-row items-center justify-center gap-2 rounded-full bg-blue px-[30px] py-[12px] text-center font-manrope font-bold hover:cursor-pointer hover:bg-btn-hover active:bg-btn-hover transition-colors duration-200">
                {isLoading
